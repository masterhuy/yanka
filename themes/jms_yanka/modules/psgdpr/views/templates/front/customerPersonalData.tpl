...
{block name='page_content'}
    ...
    <section class="page_content">
        <div class="psgdprinfo17">
            ...
            <a id="exportDataToCsv" class="btn-default psgdprgetdatabtn17" target="_blank" href="{$psgdpr_csv_controller|escape:'htmlall':'UTF-8'}">{l s='GET MY DATA TO CSV' mod='psgdpr'}</a>
            <a id="exportDataToPdf" class="btn-default psgdprgetdatabtn17" target="_blank" href="{$psgdpr_pdf_controller|escape:'htmlall':'UTF-8'}">{l s='GET MY DATA TO PDF' mod='psgdpr'}</a>
        </div>
        <div class="psgdprinfo17">
