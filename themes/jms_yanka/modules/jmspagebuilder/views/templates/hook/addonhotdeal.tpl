						...
						<div class="preview">
							{block name='product_thumbnail'}
								...
								<div class="countdown-box">
									<div class="title-countdown">{l s='Offer will end through' d='Shop.Theme.Actions'}</div>
									<div class="countdown" id="countdown-{$hotdeals[$k].id_hotdeals nofilter}">
										{$hotdeals[$k].deals_time nofilter}
									</div>
								</div>
							{/block}
						</div>
