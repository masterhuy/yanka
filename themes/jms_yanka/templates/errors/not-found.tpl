...
<section id="content" class="page-content page-not-found">
    <div class="search-not-found not-found">
        ...
        <h4>{l s='Your Search Returns no Results' d='Shop.Theme.Global'}</h4>
        <p class="small-text">{l s='Search results for' d='Shop.Theme.Global'} <span>"{$search_string}"</span></p>
    </div>
    <div class="category-not-found not-found">
        ...
        <h4>{l s='Empty Category' d='Shop.Theme.Global'}</h4>
        <p class="small-text">{l s='There are no products matching the selection.' d='Shop.Theme.Global'}</p>
        <a href="{$urls.base_url}" class="btn-border">{l s='Continue shopping' d='Shop.Theme.Global'}</a>
    </div>
