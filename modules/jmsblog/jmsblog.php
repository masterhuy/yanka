...
class JmsBlog extends Module
{
    ...
    public function install()
    {
        ...
        if (parent::install() && $this->registerHook('moduleRoutes')) {
            ...
            $res &= Configuration::updateValue('JMSBLOG_URL', 'jmsblog');
            ...
            $res &= Configuration::updateValue('JMSBLOG_COMMENT_CAPCHA', 1);
    ...
    public function uninstall()
    {
        ...
        if (parent::uninstall()) {
            ...
            $res &= Configuration::deleteByName('JMSBLOG_URL');
            ...
            $res &= Configuration::deleteByName('JMSBLOG_COMMENT_CAPCHA');
    ...
    {
        $html = '.html';
        $blog_url = Configuration::get('JMSBLOG_URL');
        return array(
            'jmsblog-categories' => array(
                'controller' => 'categories',
                'rule' => $blog_url.'/categories'.$html,
                'keywords' => array(
                ),
                'params' => array(
                    'fc' => 'module',
            ...
            'jmsblog-post' => array(
                'controller' => 'post',
                'rule' => $blog_url.'/{category_slug}/{post_id}_{slug}'.$html,
                'keywords' => array(
            ...
            'jmsblog-category' => array(
                'controller' => 'category',
                'rule' => $blog_url.'/{category_id}_{slug}'.$html,
                'keywords' => array(
            ...
            'jmsblog-archive' => array(
                'controller' => 'archive',
                'rule' => $blog_url.'/archive-month/{archive}'.$html,
                'keywords' => array(
