...
class JmsPageBuilderInstall
{
    ...
    {
        $home1_id = $this->_addHomePage('Jms Fluent - Home 1', 'home_page_1.txt', 0, 'home1.css', 'home1.js', 'home_1');
		Configuration::updateValue('JPB_HOMEPAGE', $home1_id);
		$home2_id = $this->_addHomePage('Jms Fluent - Home 2', 'home_page_2.txt', 1, 'home2.css', 'home2.js', 'home_2');
		$home3_id = $this->_addHomePage('Jms Fluent - Home 3', 'home_page_3.txt', 2, 'home3.css', 'home3.js', 'home_3');
		$home4_id = $this->_addHomePage('Jms Fluent - Home 4', 'home_page_4.txt', 3, 'home4.css', 'home4.js', 'home_4');
		$home5_id = $this->_addHomePage('Jms Fluent - Home 5', 'home_page_5.txt', 4, 'home5.css', 'home5.js', 'home_5');
		$home6_id = $this->_addHomePage('Jms Fluent - Home 6', 'home_page_6.txt', 5, 'home6.css', 'home6.js', 'home_6');
		$home7_id = $this->_addHomePage('Jms Fluent - Home 7', 'home_page_7.txt', 6, 'home7.css', 'home7.js', 'home_7');
		$home8_id = $this->_addHomePage('Jms Fluent - Home 8', 'home_page_8.txt', 7, 'home8.css', 'home8.js', 'home_8');
		$home9_id = $this->_addHomePage('Jms Fluent - Instant Shop', 'home_page_9.txt', 8, 'home-instantshop.css', 'home-instantshop.js', 'home_instantshop');
    }
}
