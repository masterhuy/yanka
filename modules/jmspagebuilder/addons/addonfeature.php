...
class JmsAddonFeature extends JmsAddonBase
{
    ...
    public function returnValue($addon)
    {
        ...
        $title = empty($addon->fields[0]->value->$id_lang) ? '' : JmsPageBuilderHelper::decodeHTML($addon->fields[0]->value->$id_lang);
        $html_content = empty($addon->fields[6]->value->$id_lang) ? '' : JmsPageBuilderHelper::decodeHTML($addon->fields[6]->value->$id_lang);
        $button_text = empty($addon->fields[7]->value->$id_lang) ? '' : JmsPageBuilderHelper::decodeHTML($addon->fields[7]->value->$id_lang);
