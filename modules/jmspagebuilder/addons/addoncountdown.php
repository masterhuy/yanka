...
class JmsAddonCountdown extends JmsAddonBase
{
    ...
    public function returnValue($addon)
    {
        ...
        $title  = empty($addon->fields[0]->value->$id_lang) ? '' : $addon->fields[0]->value->$id_lang;
        $html_content  = empty($addon->fields[4]->value->$id_lang) ? '' : JmsPageBuilderHelper::decodeHTML($addon->fields[4]->value->$id_lang);
        $button_text  = empty($addon->fields[5]->value->$id_lang) ? '' : JmsPageBuilderHelper::decodeHTML($addon->fields[5]->value->$id_lang);
