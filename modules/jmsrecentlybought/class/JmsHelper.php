...
class JmsHelper
{
    ...
    public function getProducts($ajax = false)
    {
        ...
        $address_list   = Configuration::get('JRB_ADDRESS_LIST_'.Context::getContext()->language->id);
        ...
        switch (Configuration::get('JRB_GET_PRODUCT_TYPE')) {
            ...
            case LATEST_PRODUCTS:
                ...
                break;
            case ORDERS:
                $status = Tools::jsonDecode(Configuration::get('JRB_ORDER_STATUS'));
                ...
                break;
            case PRODUCTS:
                $ids = Tools::jsonDecode(Configuration::get('JRB_SELECT_PRODUCT'));
                $results = $this->getProductsByIds($ids);
                break;
            case CATEGORIES:
                $ids = Tools::jsonDecode(Configuration::get('JRB_SELECT_CATEGORY'));
