...
if (Tools::getValue('action') == 'addLayer' && Tools::getValue('id_slide')) {
    ...
    $layer->data_order = 0;
    $layer->data_status = 1;
    $layer->desktop = Style::newType('desktop');
    $layer->mobile = Style::newType('mobile');
    $layer->mobile2 = Style::newType('mobile2');
    $layer->tablet = Style::newType('tablet');
    $layer->add();
...
//     $jms_layer->clearCache();
    ...
    $layer = new LayerObject($id_layer);
    $layer->data_image = $data_image;
    $layer->data_width = $width;
    $layer->data_height = $height;
    $layer->data_title = $data_title;
