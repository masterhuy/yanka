...
$(document).ready(function () {
    ...
    $('.displaylist').on('click', '.add-hook', function () {
        ...
        url = $('#site_url').val() + '/modules/jmsslider/ajax_sliderchoice.php?addHook';
        $.ajax({
            type : "POST",
            url : url,
            data : {
    ...
    $('.displaylist').on('click' , '.deleteHook', function () {
        ...
        item = $(this).parent();
        url = $('#site_url').val() + '/modules/jmsslider/ajax_sliderchoice.php?deleteHook';
        $.ajax({
            type : "POST",
            url : url,
            data : {
    ...
    $('.addDisplay').click(function () {
        ...
        url = $('#site_url').val() + '/modules/jmsslider/ajax_sliderchoice.php?addDisplay';
        $.ajax({
            type : "POST",
            url : url,
            data : {
    ...
    $('.displaylist').on('click' , '.deleteDisplay', function () {
        slider = $(this).attr('data-slider');
        url = $('#site_url').val() + '/modules/jmsslider/ajax_sliderchoice.php?deleteDisplay';
        $.ajax({
            type : "POST",
            url : url,
            data : {
